...
const Icons = [
  {
    component: <Instagram fontSize={"large"} />,
    link: "https://www.instagram.com/bristol_dss/",
  },
  {
    component: <Twitter fontSize={"large"} />,
    link: "https://twitter.com/bristol_dss",
  },
  {
    component: <Facebook fontSize={"large"} />,
    link: "https://www.facebook.com/BristolDSS/",
  },
  {
    component: <LinkedIn fontSize={"large"} />,
    link: "https://www.linkedin.com/company/bristol-data-science-society/",
  },
];
...
function Contact({ setActive }) {
  ...
  return (
    <Container id={"Contact"} setActive={setActive}>
      <GridContainer
        ref={ref}
        container
        direction="row"
            ...
            {inView && (
              <section>
                <TextStaggeredAnimation
                  texts={[
                    `Need to get in touch with us? Either fill out the form with your inquiry or email bristol.dss2019@gmail.com.`,
                  ]}
                />
              </section>
            )}
